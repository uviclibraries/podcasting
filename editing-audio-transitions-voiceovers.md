...
- **Click** on the **Time Shift Tool** on the top menu (see right).
...
- **Click** on the **Time Shift Tool** (see right), and **drag your voice over audio** to the part of the interview where you would like to place it.
